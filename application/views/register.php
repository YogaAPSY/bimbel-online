        ...
        <div class="form-inner">
            <form action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-controllogin" data-validation="length alphanumeric"
                        data-validation-length="3-12">
                </div>
                <div class="form-group">
                    <label style="color: white;" for="">Nama Lengkap:</label>
                    <input type="text" class="form-controllogin">
                </div>
                <div class="form-group">
                    <label style="color: white;" for="">E-mail:</label>
                    <input type="text" class="form-controllogin" data-validation="email">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-controllogin" data-validation="length"
                        data-validation-length="min8">
                </div>
                <button class="buttonlogin">create my account</button>
                <br>
                    <center> Sudah Punya Akun ?
                    <p>Login Sekarang</p></center>

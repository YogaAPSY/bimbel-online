                        ...
                        <div class="body">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-xs-5 col-sm-5 col-md-9 col-lg-9">
                                    <label style="font-size: 18px;font-weight: normal;padding-left: 0px;"></label>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <a href=""><button type="submit" name="tambah" class="btn btn-primary pull-right" style="margin-right: 20px;font-size: 16px;height: 40px;width: 100px;">SIMPAN</button></a>
                            </div>
                            </form>
                        </div>
                    </div>
